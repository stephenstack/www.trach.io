...
class ActionSuggestion extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        try {
            ...
            return (new MailMessage)
                        ->subject('Trachy Log - Action Suggestion')
                        ->greeting('Subject: ' . $this->data['subject'])
                        ->line('Hello Global Admin,')
                        ->line('The info below was sent from ' . $this->sendingUser['name'])
