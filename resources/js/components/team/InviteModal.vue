<template>
    <transition name="fade">
        ...
        <div class="modal fixed w-full h-full top-0 left-0 flex items-center justify-center">
            ...
            <div class="modal modal-container bg-white w-11/12 md:max-w-2xl mx-auto rounded shadow-lg z-50 overflow-y-auto -mt-40">
                <div class="bg-white rounded-lg w-full">

                        <div class="w-full bg-white rounded-lg mx-auto flex overflow-hidden rounded-b-none">
                            <div class="w-1/3 bg-gray-100 p-8 hidden md:inline-block">
                                <h2 class="font-medium text-md text-gray-700 mb-4 tracking-wide">Invite a friend</h2>
                                <p class="text-xs text-gray-500">Invite carers and support staff to your trach.io tenant!</p>
                            </div>
                        ...
                        <div class="p-16 py-8 bg-gray-300 clearfix rounded-b-lg border-t border-gray-200">
                            ...
                            <button
                                @click="inviteFriend()"
                                class="bg-indigo-500 text-white text-sm font-medium px-6 py-2 rounded float-right uppercase cursor-pointer hover:shadow-xl">Send
                                Invite</button>
                            <button @click="close()"
