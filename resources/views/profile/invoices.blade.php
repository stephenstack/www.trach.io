    ...
    <div class="container mx-auto max-w-5xl mt-8">
        ...
        <div class="w-full bg-white rounded-lg mx-auto mt-8 flex overflow-hidden">
            <div class="w-1/3 bg-gray-100 p-8 hidden md:inline-block">
                ...
                <p class="text-xs text-gray-500">View your invoices</p>
            </div>
                ...
                <div class="py-8 px-16">
                    ...
                    <table class="w-full">
                        ...
                        @foreach ($invoices as $invoice)
                            <tr>
                                <td class="border-b border-gray-200 py-3 text-gray-700">{{ $invoice->date()->toFormattedDateString() }}</td>
                                <td class="border-b border-gray-200 py-3 text-gray-700">{{ $invoice->total() }}</td>
                                <td class="border-b border-gray-200 py-3 text-gray-700"><a href="{{ route('invoices.download', $invoice->id) }}" class="underline text-indigo-600 font-bold">Download</a></td>
                            </tr>
                        @endforeach
                    </table>
